...
const HomePage = () => {
  ...
  return (
    <main>
        ...
        <div className="container-narrow mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="scroll-reveal">
              <img src={fieldAdvisory} alt="Janicaa Agro field advisory" className="rounded-xl shadow-lg w-full object-cover h-80" />
            </div>
            <div className="scroll-reveal space-y-5 text-muted-foreground leading-relaxed">
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-foreground">About Janicaa Agro</h2>
              <p>
              ...
              <p>
                We supply pesticides, fertilizers, seeds, cattle feed and provide expert crop advisory tailored to crop and soil conditions.
              </p>
              <p>
                Through field visits and continuous farmer support we help improve productivity, sustainability and yield outcomes.
              </p>
      ...
      <section className="section-padding" style={{ background: "var(--section-gradient)" }}>
        <div className="container-narrow mx-auto">
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-center mb-12 scroll-reveal">Our Key Offerings</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {offerings.map((item, i) => (
              <div key={i} className="scroll-reveal bg-card rounded-xl p-6 shadow-sm hover-card-effect border border-border" style={{ transitionDelay: `${i * 100}ms` }}>
      ...
      <section className="section-padding bg-card">
        <div className="container-narrow mx-auto">
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-center mb-12 scroll-reveal">Why Choose Janicaa</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {whyChoose.map((item, i) => (
              <div key={i} className="scroll-reveal text-center p-6 rounded-xl border border-border hover-card-effect bg-background" style={{ transitionDelay: `${i * 100}ms` }}>
      ...
      <section className="section-padding bg-primary">
        <div className="container-narrow mx-auto text-center scroll-reveal">
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-primary-foreground mb-8">Get In Touch</h2>
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-8">
            ...
            <div className="flex items-start gap-2 text-primary-foreground text-left">
